const CACHE='karaoke-maleta-licencas-v028';
const ROOT='/karaoke-maleta-pwa/licencas/';
const ASSETS=[ROOT,ROOT+'index.html',ROOT+'app.css?v=5',ROOT+'app.js?v=3',ROOT+'manifest.webmanifest?v=8',ROOT+'logo-km.png'];
