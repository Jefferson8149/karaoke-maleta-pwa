const CACHE='karaoke-maleta-licencas-v026';
const ROOT='/karaoke-maleta-pwa/licencas/';
const ASSETS=[ROOT,ROOT+'index.html',ROOT+'app.css?v=4',ROOT+'app.js?v=2',ROOT+'manifest.webmanifest?v=6',ROOT+'logo-km.png?v=6'];
